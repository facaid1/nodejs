...
path_to_browsermob_proxy = r"C:\Users\24405\Downloads\browsermob-proxy-2.1.4\bin\browsermob-proxy.bat"
server = Server(path_to_browsermob_proxy,options={"use-littleproxy": 'false'})
server.start()
proxy = server.create_proxy()
edge_driver_path = r"C:\Users\24405\Downloads\msedgedriver.exe"
...
username = "johnn3xturner@hotmail.com"
nickname = "KadinDanie52835"
password = "gM48qhxosbe"
...
login_button = driver.find_element("xpath", '//*[@id="layers"]/div/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div/div/div/div[6]/div')
login_button.click()
time.sleep(delay_basic)
uname = driver.find_element("xpath", '//*[@id="layers"]/div/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div[1]/div/div[2]/label/div/div[2]')
if uname.is_enabled():
    uname.send_keys(nickname)
